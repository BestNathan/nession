...
| **V4** | Narrow viewport polish (list XOR detail + capsule) — see [`2026-08-28-session-first-chatgpt-shell-v4-design.md`](./2026-08-28-session-first-chatgpt-shell-v4-design.md) |
