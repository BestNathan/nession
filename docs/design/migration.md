...
| 2 — UI patterns | [#470](https://github.com/BestNathan/nession/issues/470) | SessionList, SurfaceSwitcher, WorkspaceNavigation, and related specs |
...
The slice must validate both the IA and the new design system (tokens from #467, patterns from #470), including independent Agent / Session / attachment presentation.
