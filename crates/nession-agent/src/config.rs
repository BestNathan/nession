...
mod tests {
    ...
    #[test]
    fn test_agent_config_defaults_from_integration() {
        let config = AgentConfig::default();
        assert!(config.agent_id.starts_with("agent-"));
        assert_eq!(config.server_url, "ws://localhost:8443");
    ...
    #[test]
    fn test_agent_config_parsing_minimal_from_integration() {
        let toml = r#"
agent_id = "my-agent"
...
"#;
    ...
    #[test]
    fn test_agent_config_parsing_full_from_integration() {
        let toml = r#"
agent_id = "prod-agent"
...
"#;
    ...
    #[test]
    fn test_agent_config_parsing_optional_fields_none_from_integration() {
        let toml = r#"
agent_id = "agent-1"
server_url = "ws://localhost:8443"
auth_token = ""
