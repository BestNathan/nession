...
async fn test_generate_connection_token() {
    ...
    let token = broker.generate_p2p_token(
        "agent_123",
        "agent_123:dev-work",
        "192.168.1.10",
        8080,
...
async fn test_invalid_token() {
    ...
    let info = broker.validate_and_consume_token("invalid_token_12345").await;
    assert!(info.is_none());
}
...
async fn test_cleanup_expired_tokens() {
    ...
    let _token = broker.generate_p2p_token(
        "agent_123",
        "agent_123:dev-work",
        "192.168.1.10",
        8080,
...
async fn test_multiple_tokens_same_agent() {
    ...
    let token1 = broker.generate_p2p_token(
        "agent_123",
        "agent_123:session1",
        "192.168.1.10",
        8080,
    ...
    let token2 = broker.generate_p2p_token(
        "agent_123",
        "agent_123:session2",
        "192.168.1.10",
        8080,
