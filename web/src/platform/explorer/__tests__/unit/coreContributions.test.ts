...
import { createCoreExplorerExtension } from '@/platform/explorer/commands/coreContributions';
import type { ExplorerContextMenuContribution } from '@/platform/explorer/commands/types';
