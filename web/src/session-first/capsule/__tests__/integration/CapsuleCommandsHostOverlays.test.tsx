...
import { CapsuleCommandsHostOverlays } from '@/session-first/capsule/components/CapsuleCommandsHostOverlays';
...
import type { CapsuleContextValue } from '@/session-first/capsule/state/capsuleContext';
