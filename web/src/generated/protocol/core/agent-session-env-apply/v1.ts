...
// This file is agent.session.env.apply / v1.

/** The canonical protocol id. Not the wire type. */
export const PROTOCOL = 'agent.session.env.apply';
/** Every transport projection this contract travels as. */
export const WIRES = ['agent.session.env.apply'] as const;
/**
 ...
 */
export const WIRE = 'agent.session.env.apply';
