...
// This file is server.commands.add / v1.

/** The canonical protocol id. Not the wire type. */
export const PROTOCOL = 'server.commands.add';
/** Every transport projection this contract travels as. */
export const WIRES = ['server.commands.add'] as const;
/**
 ...
 */
export const WIRE = 'server.commands.add';
