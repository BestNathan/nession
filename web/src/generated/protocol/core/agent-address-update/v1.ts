...
// This file is agent.address-update / v1.

/** The canonical protocol id. Not the wire type. */
export const PROTOCOL = 'agent.address-update';
/** Every transport projection this contract travels as. */
export const WIRES = ['agent.address_update'] as const;
/**
 ...
 */
export const WIRE = 'agent.address_update';
