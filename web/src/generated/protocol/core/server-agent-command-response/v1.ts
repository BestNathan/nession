...
// This file is server.agent.command-response / v1.

/** The canonical protocol id. Not the wire type. */
export const PROTOCOL = 'server.agent.command-response';
/** Every transport projection this contract travels as. */
export const WIRES = ['server.agent.command-response'] as const;
/**
 ...
 */
export const WIRE = 'server.agent.command-response';
/** The contract version these shapes are. */
export const VERSION = 1;

// ── Shapes ──

export type AgentCommandResponsePayload = { request_id: string, command: string, success: boolean, error?: string | null, session_name?: string | null, };

// ── Operations ──

/** The payload a caller sends. */
export type AgentCommandResponseCall = { request_id: string, command: string, success: boolean, error?: string | null, session_name?: string | null, };
