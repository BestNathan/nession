...
// This file is server.agent.rename / v1.

/** The canonical protocol id. Not the wire type. */
export const PROTOCOL = 'server.agent.rename';
/** Every transport projection this contract travels as. */
export const WIRES = ['server.agent.rename'] as const;
/**
 ...
 */
export const WIRE = 'server.agent.rename';
