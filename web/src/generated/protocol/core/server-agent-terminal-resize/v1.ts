...
// This file is server.agent.terminal-resize / v1.

/** The canonical protocol id. Not the wire type. */
export const PROTOCOL = 'server.agent.terminal-resize';
/** Every transport projection this contract travels as. */
export const WIRES = ['server.agent.terminal-resize'] as const;
/**
 ...
 */
export const WIRE = 'server.agent.terminal-resize';
