...
// This file is session.env.query / v1.

/** The canonical protocol id. Not the wire type. */
export const PROTOCOL = 'session.env.query';
/** Every transport projection this contract travels as. */
export const WIRES = ['client.session.env.query'] as const;
/**
 ...
 */
export const WIRE = 'client.session.env.query';
