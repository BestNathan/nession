...
// This file is server.agent.register / v1.

/** The canonical protocol id. Not the wire type. */
export const PROTOCOL = 'server.agent.register';
/** Every transport projection this contract travels as. */
export const WIRES = ['server.agent.register'] as const;
/**
 ...
 */
export const WIRE = 'server.agent.register';
