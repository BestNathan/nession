...
// This file is agent.terminal.input / v1.

/** The canonical protocol id. Not the wire type. */
export const PROTOCOL = 'agent.terminal.input';
/** Every transport projection this contract travels as. */
export const WIRES = ['agent.terminal.input'] as const;
/**
 ...
 */
export const WIRE = 'agent.terminal.input';
