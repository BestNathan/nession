...
// This file is session.relay.begin / v1.

/** The canonical protocol id. Not the wire type. */
export const PROTOCOL = 'session.relay.begin';
/** Every transport projection this contract travels as. */
export const WIRES = ['client.session.relay.begin'] as const;
/**
 ...
 */
export const WIRE = 'client.session.relay.begin';
