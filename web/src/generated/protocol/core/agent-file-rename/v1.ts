...
// This file is agent.file.rename / v1.

/** The canonical protocol id. Not the wire type. */
export const PROTOCOL = 'agent.file.rename';
/** Every transport projection this contract travels as. */
export const WIRES = ['agent.file.rename'] as const;
/**
 ...
 */
export const WIRE = 'agent.file.rename';
