...
// This file is server.agent.delete / v1.

/** The canonical protocol id. Not the wire type. */
export const PROTOCOL = 'server.agent.delete';
/** Every transport projection this contract travels as. */
export const WIRES = ['server.agent.delete'] as const;
/**
 ...
 */
export const WIRE = 'server.agent.delete';
