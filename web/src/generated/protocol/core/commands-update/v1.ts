...
// This file is commands.update / v1.

/** The canonical protocol id. Not the wire type. */
export const PROTOCOL = 'commands.update';
/** Every transport projection this contract travels as. */
export const WIRES = ['client.commands.update'] as const;
/**
 ...
 */
export const WIRE = 'client.commands.update';
