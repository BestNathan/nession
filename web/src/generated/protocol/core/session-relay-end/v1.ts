...
// This file is session.relay.end / v1.

/** The canonical protocol id. Not the wire type. */
export const PROTOCOL = 'session.relay.end';
/** Every transport projection this contract travels as. */
export const WIRES = ['client.session.relay.end'] as const;
/**
 ...
 */
export const WIRE = 'client.session.relay.end';
