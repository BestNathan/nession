...
// This file is server.commands.remove / v1.

/** The canonical protocol id. Not the wire type. */
export const PROTOCOL = 'server.commands.remove';
/** Every transport projection this contract travels as. */
export const WIRES = ['server.commands.remove'] as const;
/**
 ...
 */
export const WIRE = 'server.commands.remove';
