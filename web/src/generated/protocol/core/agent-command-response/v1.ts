...
// This file is agent.command-response / v1.

/** The canonical protocol id. Not the wire type. */
export const PROTOCOL = 'agent.command-response';
/** Every transport projection this contract travels as. */
export const WIRES = ['agent.session.command.response'] as const;
/**
 ...
 */
export const WIRE = 'agent.session.command.response';
