...
// This file is server.session.capture-preview / v1.

/** The canonical protocol id. Not the wire type. */
export const PROTOCOL = 'server.session.capture-preview';
/** Every transport projection this contract travels as. */
export const WIRES = ['server.session.capture-preview'] as const;
/**
 ...
 */
export const WIRE = 'server.session.capture-preview';
