...
function SheetOverlay({ className, blur = true, ...props }: SheetPrimitive.Backdrop.Props & {
  blur?: boolean
}) {
  return (
    <SheetPrimitive.Backdrop
      ...
      className={cn(
        "fixed inset-0 z-50 bg-overlay/10 transition-opacity duration-150 data-ending-style:opacity-0 data-starting-style:opacity-0",
