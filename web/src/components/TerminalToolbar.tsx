...
export function TerminalToolbar({ sendText }: TerminalToolbarProps) {
  ...
  return (
    <Collapsible
      ...
      className="border-t bg-muted/30 flex-shrink-0"
    >
      ...
      <CollapsibleContent>
        <div className="px-3 pb-3 space-y-3">
            ...
            {showAddForm ? (
              <div className="flex items-center gap-1 w-full mt-1">
                ...
                <Input
                  ...
                  className="h-7 text-xs flex-1 min-w-0"
                />
                <Button size="sm" className="h-7 text-xs" onClick={addUserCommand}>
                  Add
                </Button>
                <Button size="sm" variant="ghost" className="h-7 text-xs" onClick={cancelAddForm}>
                  Cancel
                </Button>
              </div>
            ) : (
          ...
          <div className="flex gap-2">
            ...
            />
            <Button onClick={sendInput} size="sm" className="self-end">
              Send
            </Button>
          </div>
        </div>
