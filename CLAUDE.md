...
nession/
├── .claude/
│   └── skills/                         # AI path: task-specific project instructions
│       ├── nession-development/        # Development, testing, and PR workflow
│       ├── nession-cicd/               # CI/CD, releases, and branch integration
│       ├── nession-env/                # Environment setup and diagnostics
│       └── nession-writing-requirements/ # Requirements and bug issues
